...
> Complex problems requiring sophisticated algorithms, advanced mathematics, and creative problem-solving.
...
| 216 | [Investigating the Primality of Numbers of the Form 2n^2-1](https://projecteuler.net/problem=216) | - |
...
| 226-300 | [Problems 226-300](https://projecteuler.net/archives) | - |

### Legend: `-` Not started | `WIP` In progress | `done` Solved
